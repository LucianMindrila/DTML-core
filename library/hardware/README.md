...
Confirmed hardware/fitting standards (hinges, shelf pins, KD fittings,
runners, lighting profiles, handles), each declaring the one variable it
standardises on per `../../docs/CorePrinciples.md` #2.
...
`../../docs/KnowledgeCapture.md` and RFC-0003.
